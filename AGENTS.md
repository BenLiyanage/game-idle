...
- Treat authoritative lifecycle labels as state: after an ambiguous GitHub API failure, re-read and reconcile observed labels before deciding the result. Best-effort comments and notifications must not determine authoritative lifecycle success.
